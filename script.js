const englishText = {
  ...
  "Beş uygulamam kapalı testte.": "Five of my apps are in closed testing.",
  "Notistan, Age of Tycoon, Online Pişti, Fruit Defense ve Dust Off için yeni test kullanıcılarını kabul ediyorum. Deneyip geri bildirim bırakarak geliştirme sürecine katkıda bulunabilirsin.": "I'm currently accepting new testers for Notistan, Age of Tycoon, Online Pişti, Fruit Defense and Dust Off. You can try them and contribute to the development process by sharing your feedback.",
  "5 uygulama aktif testte": "5 apps currently in testing",
  ...
  "Kapalı test · Teste açık": "Closed Testing · Open for Testers",
  ...
  "Meyve temalı savunma kuleleriyle bahçeyi böcek istilalarına karşı koruduğun, bölge bazlı ilerleme ve stratejik kule yerleşimine odaklanan mobil tower defense oyunu.": "A mobile tower defense game where you protect the garden from insect invasions using fruit-themed defense towers, with a focus on region-based progression and strategic tower placement.",
  "Her biri farklı savaş rolüne sahip meyve temalı savunma kuleleriyle stratejik savunmalar oluştur.": "Build strategic defenses with fruit-themed towers, each designed for a different combat role.",
  "Kule yerleşimi, yükseltmeler ve farklı saldırı tiplerini doğru kullanarak değişen düşman dalgalarına karşı koy.": "Counter changing enemy waves by combining smart tower placement, upgrades and different attack types.",
  "Farklı temalara, rotalara ve zorluk seviyelerine sahip bölgelerde ilerleyerek yeni mücadelelere ulaş.": "Progress through regions with different themes, routes and difficulty levels to face new challenges.",
  "Savunma kulelerini oyun sırasında geliştirerek hasar, saldırı hızı ve savaş etkinliğini artır.": "Upgrade your defense towers during battle to improve their damage, attack speed and overall effectiveness.",
  "Farklı hız, dayanıklılık ve davranışlara sahip böcek düşmanlarına karşı uygun kule kombinasyonlarını kullan.": "Use the right tower combinations against insect enemies with different speeds, durability and behaviors.",
  "Oyun motoru, sahne sistemi ve oyun döngüsü": "Game engine, scene system and core gameplay loop",
  "Gameplay sistemleri ve uygulama mantığı": "Gameplay systems and application logic",
  "Mobil dağıtım ve Google Play yayını": "Mobile distribution and Google Play release",
  "Region, wave ve gameplay içeriklerinin yönetimi": "Management of region, wave and gameplay content",
  "Hassas restorasyon araçlarını kullanarak toz ve kir altında kalmış tarihi eserleri ortaya çıkardığın, dikkat ve kontrollü temizlik üzerine kurulu mobil arkeoloji ve restorasyon oyunu.": "A mobile archaeology and restoration game built around precision and controlled cleaning, where you use specialized tools to uncover historical artifacts hidden beneath layers of dust and dirt.",
  "Toz ve kir altında kalmış tarihi objeleri dikkatli şekilde temizleyerek gerçek görünümlerini ortaya çıkar.": "Carefully clean historical objects covered in dust and dirt to reveal their original appearance.",
  "Farklı temizlik durumlarına uygun Pick, Brush ve Air araçlarını kullanarak restorasyonu kontrollü şekilde gerçekleştir.": "Use Pick, Brush and Air tools for different cleaning situations and restore artifacts with greater control.",
  "Eserin durumunu korurken mümkün olan en iyi restorasyon sonucuna ulaşmaya çalış.": "Aim for the best restoration result while carefully preserving the condition of each artifact.",
  "Yeni eserler ve seviyeler keşfederek restorasyon koleksiyonunu ilerlet.": "Unlock new artifacts and levels as you expand your restoration collection.",
  "Tamamlama süresi, keşfedilen bölüm ve restorasyon performansı gibi sonuçlarla kişisel performansını takip et.": "Track results such as completion time, discovered areas and restoration performance.",
  "Daha iyi süre ve sonuç elde etmek için tamamlanan restorasyonları tekrar oynayabil.": "Replay completed restorations to achieve better times and improved results.",
  "Oyun motoru, sahne sistemi ve render": "Game engine, scene system and rendering",
  "Liderlik tablosu ve oyuncu veritabanı": "Leaderboard and player database",
  "Mobil dağıtım ve Play Store yayını": "Mobile distribution and Play Store release"
,
  ...
  "Reklam ve Google Play entegrasyonları": "Advertising and Google Play integrations",
  "Capacitor & Modern Web Teknolojileri": "Capacitor & Modern Web Technologies",
  "Vercel & Google Play Console": "Vercel & Google Play Console",
  "Google AdMob & Play Services": "Google AdMob & Play Services",
  "Dart Timer.periodic": "Dart Timer.periodic",
  "audioplayers": "audioplayers",
  "App Sandbox": "App Sandbox",
  "macOS 14.0+": "macOS 14.0+",
  "Node.js, Capacitor & Android Studio": "Node.js, Capacitor & Android Studio",
  "Git & GitHub": "Git & GitHub",
  "Capacitor & App Lifecycle API": "Capacitor & App Lifecycle API",
  "Google AdMob": "Google AdMob",
  "React & TypeScript": "React & TypeScript",
  "Flutter & Dart": "Flutter & Dart",
  "Swift 5.0 & SwiftUI": "Swift 5.0 & SwiftUI",
  "HTML5, CSS3 & Vanilla JavaScript": "HTML5, CSS3 & Vanilla JavaScript",
  ...
  "Swift ve SwiftUI ile geliştirilmiş, istatistik paneline sahip native bir görev yönetim uygulaması.": "A native task management app built with Swift and SwiftUI, featuring a statistics dashboard.",
  "Can sıkıntısından yaptığım; klasik 2048 mantığını 3, 6, 12… 3072 sayı dizisiyle yeniden yorumlayan bulmaca oyunu.": "A puzzle game I made out of boredom, reimagining classic 2048 with the sequence 3, 6, 12… 3072.",
  "geliştirdiğim ve bazen yalnızca can sıkıntısından yaptığım projeleri de burada tutuyorum.": "I keep the projects I built while learning—and sometimes simply out of boredom—right here.",
  "Kapalı testteki yeni uygulamalarımın yanında, öğrenme sürecimde": "Alongside my new apps in closed testing, I keep the projects I built while learning",
  "Notistan, Age of Tycoon ve Online Pişti'nin Play Store sayfalarını görebilmek için önce test grubuna, Play Store'da kullandığın aynı Google hesabıyla katılman gerekiyor.": "To view the Play Store pages for Notistan, Age of Tycoon, and Online Pişti, first join the testing group with the same Google account you use on the Play Store.",
  "Google Play · Kapalı test erişimi": "Google Play · Closed test access",
  "Açık kaynak": "Open source",
  "Tamamlandı": "Completed",
...
"Fruit Defense uygulama ikonu": "Fruit Defense app icon",
  "Dust Off uygulama ikonu": "Dust Off app icon",
  "Fruit Defense detaylarını kapat": "Close Fruit Defense details",
  "Dust Off detaylarını kapat": "Close Dust Off details"
};
